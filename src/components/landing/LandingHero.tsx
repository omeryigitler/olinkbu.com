      ...
      <div className="relative z-10 grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="space-y-8">
          <div className="inline-flex items-center gap-3 rounded-full bg-white px-5 py-3 text-sm font-black shadow-[0_12px_40px_rgba(15,23,42,0.12)] ring-1 ring-black/5">
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-red-600 text-white"><Youtube className="h-4 w-4 fill-current" /></span>
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-green-500 text-white"><Music className="h-4 w-4" /></span>
            <span>YouTube ve Spotify <span className="text-red-600">anlarını yakala</span></span>
          </div>
          ...
          <div className="max-w-xl space-y-4">
            ...
            <button className="flex w-full items-center justify-center gap-3 rounded-2xl border border-red-500 bg-white px-6 py-4 text-sm font-black uppercase tracking-wide text-red-600 transition hover:bg-red-50">
          ...
          <div className="rounded-[1.6rem] bg-white p-5 shadow-[0_30px_100px_rgba(15,23,42,0.18)] ring-1 ring-black/10">
            ...
            <div className="relative aspect-video overflow-hidden rounded-2xl bg-slate-900">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/10">
                <button className="flex h-20 w-20 items-center justify-center rounded-full bg-black/45 text-white backdrop-blur-sm transition hover:scale-105">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white p-3 shadow-[0_10px_30px_rgba(15,23,42,0.10)] ring-1 ring-black/5">
                ...
                <button className="hidden rounded-xl bg-red-600 px-6 py-4 text-sm font-black text-white shadow-[0_14px_30px_rgba(225,0,15,0.25)] sm:inline-flex">
